export class AccountListController {
  ...
  onDeleteAccount(userAccount) {
    ...
    var confirm = this.$mdDialog.prompt()
          .title("Would you like to remove this Bitbucket integration with Yellowant?")
          .textContent(`Please type in your Bitbucket handle to confirm: ${userAccount.user_invoke_name}`)
          .placeholder("bitbucket-handle")
          .ariaLabel("Bitbucket Handle")
